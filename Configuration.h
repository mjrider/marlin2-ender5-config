...
#define STRING_CONFIG_H_AUTHOR "(mjrider, Ender-5)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 81.77
  #define DEFAULT_bedKi 15.23
  #define DEFAULT_bedKd 292.67
#endif // PIDTEMPBED
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 98.41  }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -12, -1.97 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS -1), (Y_MAX_POS - 10), 20 }
